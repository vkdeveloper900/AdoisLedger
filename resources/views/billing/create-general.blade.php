@extends('layouts.app')
@section('title', 'New Bill — General')
...
@csrf
<input type="hidden" name="type" value="general_sale">
        ...
        <div class="card invoice-preview-card">
            ...
            <div class="card-body">
                ...
                <div class="row g-2 d-none d-md-flex mb-1 px-1">
                    <div class="col-md-5"><small class="text-body-secondary">Item</small></div>
...
function addRow() {
    ...
    const row = `<div class="row g-2 align-items-end border-bottom py-2 item-row">
        <div class="col-12 col-md-5">
            <label class="d-md-none form-label mb-1">Item</label>
            <input type="text" name="items[${rowCount}][description]" class="form-control" placeholder="Item name" required>
            <input type="hidden" name="items[${rowCount}][unit]" value="piece">
        </div>
        ...
        <div class="col-5 col-md-2">
            <label class="d-md-none form-label mb-1">Rate</label>
