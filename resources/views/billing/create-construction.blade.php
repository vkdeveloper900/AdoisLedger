@extends('layouts.app')
@section('title', 'New Bill — Construction')
...
<div class="d-flex align-items-center mb-4">
    ...
    <button type="button" class="btn btn-sm btn-outline-primary ms-auto" data-bs-toggle="offcanvas" data-bs-target="#quickCustomerOffcanvas">
...
@csrf
<input type="hidden" name="type" value="construction_sale">
        ...
        <div class="card invoice-preview-card">
            ...
            <div class="card-body">
                <div class="row g-2 d-none d-md-flex mb-1 px-1">
                    <div class="col-md-3"><small class="text-body-secondary">Material</small></div>
                    <div class="col-md-2"><small class="text-body-secondary">Unit</small></div>
                    <div class="col-md-2"><small class="text-body-secondary">Qty</small></div>
                    <div class="col-md-2"><small class="text-body-secondary">Rate</small></div>
...
function addRow() {
    ...
    const row = `<div class="row g-2 align-items-end border-bottom py-2 item-row">
        <div class="col-12 col-md-3">
            <label class="d-md-none form-label mb-1">Material</label>
            <select name="items[${rowCount}][description]" class="form-select" required>${matOpts}</select>
        </div>
        <div class="col-5 col-md-2">
            <label class="d-md-none form-label mb-1">Unit</label>
            <select name="items[${rowCount}][unit]" class="form-select">${unitOpts}</select>
        </div>
        <div class="col-5 col-md-2">
            <label class="d-md-none form-label mb-1">Qty</label>
            <input type="number" name="items[${rowCount}][qty]" class="form-control item-qty" step="0.001" min="0" placeholder="0" required>
        </div>
        <div class="col-5 col-md-2">
            <label class="d-md-none form-label mb-1">Rate / Unit</label>
